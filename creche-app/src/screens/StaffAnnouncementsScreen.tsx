 ...
 * 
 * Staff screen for viewing announcements.
...
type StaffAnnouncementsScreenProps = {
  onBack?: () => void;
};

export default function StaffAnnouncementsScreen({
  onBack,
}: StaffAnnouncementsScreenProps) {
   ...
   */
  useEffect(() => {
    console.log("[StaffAnnouncementsScreen] Setting up subscription for staff");

    const unsubscribe = subscribeAnnouncements(
      (updatedAnnouncements) => {
        console.log(
          `[StaffAnnouncementsScreen] Received ${updatedAnnouncements.length} announcements`
        );
    ...
    return () => {
      console.log("[StaffAnnouncementsScreen] Cleaning up subscription");
      unsubscribe();
    };
  }, []);
